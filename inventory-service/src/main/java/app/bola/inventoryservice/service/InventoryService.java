package app.bola.inventoryservice.service;

import app.bola.inventoryservice.dto.AddStockRequest;
import app.bola.inventoryservice.dto.StockCheckResponse;
import app.bola.inventoryservice.exception.InventoryCheckException;
import app.bola.inventoryservice.feignclient.ProductClient;
import app.bola.inventoryservice.model.Inventory;
import app.bola.inventoryservice.repository.InventoryRepository;
